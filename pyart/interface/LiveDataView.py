...
from pyart.interface.LiveDataChildWindows import SampleLogPlotSetupDialog
from pyart.interface.LiveDataChildWindows import LiveViewSetupDialog
from pyart.interface.livedatagraphicswidgets import SingleBankView
